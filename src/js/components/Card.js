...
export const Card = function (noteData) {
     ...
     * 
     * Attaches a click event listener to card elment.
     ...
     * If the deltion is confirmed, it updates the UI and database to remove the note.
     */
    ...
    $deleteBtn.addEventListener('click', function (event) {
        ...
        modal.onSubmit(function (isConfirm) {
            ...
            if (isConfirm) {
                ...
                // Update the client ui to reflect notedeletion 
