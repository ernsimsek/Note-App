...
const /**  {HTMLElemet} */ $sidebar = document.querySelector('[data-sidebar]');
const /**  {Array<HTMLElemet} */ $sidebarTogglers = document.querySelectorAll('[data-sidebar-toggler]');
const /**  {HTMLElemet} */ $overlay = document.querySelector('[data-sidebar-overlay]');
...
/**
 * Initialize tooltip behavior fal all DOM elements with 'data-tooltip' attribute.
 */
...
const /**  {HTMLElemet} */ $greetElem = document.querySelector('[data-greeting]');
 ...
 * and uses the clint to display the notes.
 */
