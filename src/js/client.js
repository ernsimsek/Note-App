...
const /** {Array<HTMLElement>} */ $notCreateBtns = document.querySelectorAll('[data-note-create-btn]')
    ...
    notebook: {
        ...
        * @param {Array<Object>} notebookList - List of notebook data to display.
        ...
        delete(notebookId) {
            ...
            const /** {HTMLElement | null} */ $actineNavItem = $deletedNotebook.nextElementSibling ?? $deletedNotebook.previousElementSibling
